...
<div class="container-fluid">
		<nav class="navbar bg-warning">
			<img src="images/flogo.jpg" height="90px" width="180px" style="margin-left: 177px;" >
			<!-- <ul class="nav">
			<li class="nav-item "><a href="" class="btn btn-primary"
				...
				<li class="nav-item "><a href="" class="btn btn-primary"
					...
					<li class="nav-item "><a href="" class="btn btn-primary"
					data-target="#Signout" data-toggle="modal"><i class="fas fa-"></i><i class='fas fa-lock'></i>&nbsp;LogOut</a></li>&nbsp;
